export class AbstractGrid {
	 ...
	 * @param {Number} index
	 * @returns {import('./polygonutils').RegularPolygonTile|
	 * import('./polygonutils').TransformedPolygonTile}
	 */
	polygon_at(index) {
	 ...
	 * @param {import('./viewbox').ViewBox} box
	 * @returns {import('./viewbox').VisibleTile[]}
	 */
	getVisibleTiles(box) {
	 ...
	 * @param {import('./controls').PointerOrigin} point
	 */
	whichEdge(point) {
