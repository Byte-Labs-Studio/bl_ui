 ...
 * @property {ControlMode} controlMode - The control mode for the game.
 * @property {boolean} invertRotationDirection - Whether to invert the rotation direction.
 * @property {boolean} showTimer - Whether to show the timer.
 * @property {boolean} disableZoomPan - Whether zoom and pan are disabled.
 * @property {boolean} assistant - Whether the assistant is enabled.
 * @property {AnimationSpeed} animationSpeed - The speed of animations.
 */
 ...
 * @param {import('./game').PipesGame} game
 * @returns
 */
